    ...
    return (
        <section className="project">  
            ...
            <div className="page-content">
                ...
                after learning Git from the <a href='https://www.Boot.dev'>BootDev</a> course.
                Still, there was a lot of improvements that could have been made to this project.
                Nonetheless, a massive improvement from the <Link className="homeLink" to='/projects/blobGame'>Blob Game</Link>.<br></br>
